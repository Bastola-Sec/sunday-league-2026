...
export const AdminPortalModal: React.FC<AdminPortalModalProps> = ({
  ...
  // When mode or teams change, default correctly
  useEffect(() => {
    if (mode === 'commissioner') {
      setLoginTeamId('all');
    } else {
      setLoginTeamId(teams[0]?.id || '');
    }
  }, [mode, teams]);
                ...
                <div className="p-6 rounded-3xl bg-[#060b14]/90 border border-[#B7CEEC]/30 space-y-5 max-w-xl mx-auto shadow-[0_0_35px_rgba(76,120,126,0.15)] backdrop-blur-2xl">
                  ...
                  <form onSubmit={handlePasscodeLogin} className="space-y-4">
                    ...
                    >
                      ...
                      <span>{mode === 'commissioner' ? 'AUTHENTICATE COMMISSIONER' : 'AUTHENTICATE CLUB ADMIN'}</span>
                    </button>
                  </form>
